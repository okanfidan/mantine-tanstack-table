import classes from "./MTT_ColumnActionMenu.module.css";
...
interface Props<TData extends MTT_RowData> extends MenuProps {
  header: MTT_Header<TData>;
  table: MTT_TableInstance<TData>;
}

export const MTT_ColumnActionMenu = <TData extends MTT_RowData>({
  header,
  table,
  ...rest
}: Props<TData>) => {
  ...
  const handleGroupByColumn = () => {
    ...
    setColumnOrder((old: any) => ["mtt-row-expand", ...old]);
  };
