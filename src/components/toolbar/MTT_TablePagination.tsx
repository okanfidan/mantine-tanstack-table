...
import classes from "./MTT_TablePagination.module.css";
...
interface Props<TData extends MTT_RowData> extends Partial<PaginationProps> {
  position?: "bottom" | "top";
  table: MTT_TableInstance<TData>;
}

export const MTT_TablePagination = <TData extends MTT_RowData>({
  position = "bottom",
  table,
  ...props
}: Props<TData>) => {
