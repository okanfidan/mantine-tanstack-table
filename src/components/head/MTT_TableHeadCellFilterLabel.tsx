...
import classes from "./MTT_TableHeadCellFilterLabel.module.css";
...
export const MTT_TableHeadCellFilterLabel = <TData extends MTT_RowData>({
  header,
  table,
  ...rest
}: Props<TData>) => {
            ...
            <Popover.Target>
              ...
              >
                <ActionIcon
                  ...
                  className={clsx(
                    "mtt-table-head-cell-filter-label-icon",
                    classes.root,
                  )}
                  size={18}
