...
export const getMTT_Rows = <TData extends MTT_RowData>(
...
export const getCanRankRows = <TData extends MTT_RowData>(
  table: MTT_TableInstance<TData>,
) => {
  const {
    getState,
...
export const getIsRankingRows = <TData extends MTT_RowData>(
  table: MTT_TableInstance<TData>,
) => {
...
export const getIsRowSelected = <TData extends MTT_RowData>({
  row,
  table,
}: {
  row: MTT_Row<TData>;
...
export const getMTT_RowSelectionHandler =
...
export const getMTT_SelectAllHandler =
  <TData extends MTT_RowData>({ table }: { table: MTT_TableInstance<TData> }) =>
  (
