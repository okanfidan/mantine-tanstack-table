...
export const useMTT_RowVirtualizer = <
...
>(
  ...
  rows?: MTT_Row<TData>[],
): MTT_RowVirtualizer<TScrollElement, TItemElement> | undefined => {
  const {
    getRowModel,
    getState,
    options: {
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    ...rowVirtualizerProps,
  }) as unknown as MTT_RowVirtualizer<TScrollElement, TItemElement>;
