...
const fuzzy = <TData extends MTT_RowData>(
  row: Row<TData>,
  columnId: string,
...
const contains = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
) =>
...
const startsWith = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
) =>
...
const endsWith = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
) =>
...
const equals = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
) =>
...
const notEquals = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
) =>
...
const greaterThan = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
) =>
...
const greaterThanOrEqualTo = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
...
const lessThan = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
) =>
...
const lessThanOrEqualTo = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
...
const between = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
...
const betweenInclusive = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  filterValues: [number | string, number | string],
) =>
...
const empty = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
...
const notEmpty = <TData extends MTT_RowData>(
  row: Row<TData>,
  id: string,
  _filterValue: number | string,
) => !!row.getValue<number | string>(id)?.toString().trim();
...
export function localizedFilterOption(
  ...
  option: MTT_FilterOption,
) {
  if (!option) {
    return "";
  }
  const key = `filter${option[0].toUpperCase()}${option.slice(1)}`;
  return localization[key as keyof MTT_Localization] ?? "";
}
