...
const MTT_TableBodyCell = (_a) => {
    ...
    const renderCellContent = () => {
        ...
        if (isCreating || isEditing) {
            return jsxRuntime.jsx(MTT_EditCellTextInput, { cell: cell, table: table });
        }
        if (showClickToCopyButton && columnDef.enableClickToCopy !== false) {
            return (jsxRuntime.jsx(MTT_CopyButton, { cell: cell, table: table, children: jsxRuntime.jsx(MTT_TableBodyCellValue, Object.assign({}, cellValueProps)) }));
        }
        return jsxRuntime.jsx(MTT_TableBodyCellValue, Object.assign({}, cellValueProps));
    };
...
const Memo_MTT_TableBodyCell = react.memo(MTT_TableBodyCell, (prev, next) => next.cell === prev.cell);
...
const MTT_TableDetailPanel = (_a) => {
    ...
    const internalEditComponents = row
        ...
        .map((cell) => (jsxRuntime.jsx(MTT_EditCellTextInput, { cell: cell, table: table }, cell.id)));
...
const MTT_SortingFns = Object.assign(Object.assign({}, reactTable.sortingFns), { fuzzy: fuzzy$1 });
                    ...
                    if (node) {
                        ...
                        : (virtualColumns !== null && virtualColumns !== void 0 ? virtualColumns : row.getVisibleCells()).map((cellOrVirtualCell, renderedColumnIndex) => {
                            ...
                            return memoMode === "cells" &&
                                ...
                                !draggingRow &&
                                (editingCell === null || editingCell === void 0 ? void 0 : editingCell.id) !== cell.id &&
                                (editingRow === null || editingRow === void 0 ? void 0 : editingRow.id) !== row.id ? (jsxRuntime.jsx(Memo_MTT_TableBodyCell, Object.assign({}, cellProps), cell.id)) : (jsxRuntime.jsx(MTT_TableBodyCell, Object.assign({}, cellProps), cell.id));
                        }), virtualPaddingRight ? (jsxRuntime.jsx(core.Box, { component: "td", display: "flex", w: virtualPaddingRight })) : null] })), renderDetailPanel && !row.getIsGrouped() && (jsxRuntime.jsx(MTT_TableDetailPanel, { parentRowRef: rowRef, renderedRowIndex: renderedRowIndex, row: row, rowVirtualizer: rowVirtualizer, striped: striped, table: table, virtualRow: virtualRow }))] }));
};
const Memo_MTT_TableBodyRow = react.memo(MTT_TableBodyRow, (prev, next) => prev.row === next.row);
...
const MTT_TableBodyEmptyRow = (_a) => {
    ...
    const emptyRow = react.useMemo(() => reactTable.createRow(table, "mtt-row-empty", {}, 0, 0), []);
    const emptyRowProps = Object.assign(Object.assign({}, commonRowProps), { renderedRowIndex: 0, row: emptyRow, virtualRow: undefined });
    return (jsxRuntime.jsxs(MTT_TableBodyRow, Object.assign({ className: clsx("mtt-table-body-row", (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$C["empty-row-tr-grid"]), table: table, tableProps: tableProps }, emptyRowProps, { children: [renderDetailPanel && (jsxRuntime.jsx(core.TableTd, { className: clsx("mtt-table-body-cell", (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$C["empty-row-td-grid"]), colSpan: 1, children: jsxRuntime.jsx(MTT_ExpandButton, { row: emptyRow, table: table }) })), jsxRuntime.jsx("td", { className: clsx("mtt-table-body-cell", (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$C["empty-row-td-grid"]), colSpan: table.getVisibleLeafColumns().length, children: (_b = renderEmptyRowsFallback === null || renderEmptyRowsFallback === void 0 ? void 0 : renderEmptyRowsFallback({ table })) !== null && _b !== void 0 ? _b : (jsxRuntime.jsx(core.Text, { __vars: {
...
const useMTT_Rows = (table) => {
    ...
    const rows = react.useMemo(() => getMTT_Rows(table), [
        creatingRow,
        data,
        enableGlobalFilterRankedResults,
        expanded,
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [!(rowPinningDisplayMode === null || rowPinningDisplayMode === void 0 ? void 0 : rowPinningDisplayMode.includes("sticky")) &&
                getIsSomeRowsPinned("top") && (jsxRuntime.jsx(core.TableTbody, Object.assign({}, tableBodyProps, { __vars: Object.assign({ "--mtt-table-head-height": `${tableHeadHeight}` }, tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.__vars), className: clsx(classes$C.pinned, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$C["root-grid"], tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.className), children: getTopRows().map((row, renderedRowIndex) => {
                    ...
                    return memoMode === "rows" ? (jsxRuntime.jsx(Memo_MTT_TableBodyRow, Object.assign({}, rowProps), row.id)) : (jsxRuntime.jsx(MTT_TableBodyRow, Object.assign({}, rowProps), row.id));
                        ...
                        return memoMode === "rows" ? (jsxRuntime.jsx(Memo_MTT_TableBodyRow, Object.assign({}, props), key)) : (jsxRuntime.jsx(MTT_TableBodyRow, Object.assign({}, props), key));
                ...
                getIsSomeRowsPinned("bottom") && (jsxRuntime.jsx(core.TableTbody, Object.assign({}, tableBodyProps, { __vars: Object.assign({ "--mtt-table-footer-height": `${tableFooterHeight}` }, tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.__vars), className: clsx(classes$C.pinned, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$C["root-grid"], tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.className), children: getBottomRows().map((row, renderedRowIndex) => {
                    const props = Object.assign(Object.assign({}, commonRowProps), { renderedRowIndex,
                        row });
                    return memoMode === "rows" ? (jsxRuntime.jsx(Memo_MTT_TableBodyRow, Object.assign({}, props), row.id)) : (jsxRuntime.jsx(MTT_TableBodyRow, Object.assign({}, props), row.id));
                }) })))] }));
};
const Memo_MTT_TableBody = react.memo(MTT_TableBody, (prev, next) => prev.table.options.data === next.table.options.data);
...
const MTT_TableBodyRowGrabHandle = (_a) => {
    ...
    return (jsxRuntime.jsx(MTT_GrabHandleButton, { actionIconProps: actionIconProps, onDragEnd: handleDragEnd, onDragStart: handleDragStart, table: table }));
};
...
const MTT_TableBodyRowPinButton = (_a) => {
    ...
    if (rowPinningDisplayMode === "top-and-bottom" && !row.getIsPinned()) {
        return (jsxRuntime.jsxs(core.Box, { style: {
            ...
            }, children: [jsxRuntime.jsx(MTT_RowPinButton, Object.assign({ pinningPosition: "top" }, rowPinButtonProps)), jsxRuntime.jsx(MTT_RowPinButton, Object.assign({ pinningPosition: "bottom" }, rowPinButtonProps))] }));
    }
    return (jsxRuntime.jsx(MTT_RowPinButton, Object.assign({ pinningPosition: rowPinningDisplayMode === "bottom" ? "bottom" : "top" }, rowPinButtonProps)));
};
...
const MTT_ShowHideColumnsMenuItems = ({ allColumns, column, hoveredColumn, setHoveredColumn, table, }) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(core.Menu.Item, Object.assign({ className: classes$r.root, component: "span", onDragEnter: handleDragEnter, ref: menuItemRef, style: {
                    ...
                    "--_hover-color": getPrimaryColor(theme),
                            ...
                            (columnDef.enableColumnOrdering !== false ? (jsxRuntime.jsx(MTT_GrabHandleButton, { onDragEnd: handleDragEnd, onDragStart: handleDragStart, table: table })) : (jsxRuntime.jsx(core.Box, { className: classes$r.grab }))), enableColumnPinning &&
                            (column.getCanPin() ? (jsxRuntime.jsx(MTT_ColumnPinningButtons, { column: column, table: table })) : (jsxRuntime.jsx(core.Box, { className: classes$r.pin }))), enableHiding ? (jsxRuntime.jsx(core.Tooltip, { label: localization.toggleVisibility, openDelay: 1000, withinPortal: true, children: jsxRuntime.jsx(core.Switch, { checked: switchChecked, className: classes$r.switch, disabled: !column.getCanHide(), label: columnDef.header, onChange: () => handleToggleColumnHidden(column) }) })) : (jsxRuntime.jsx(core.Text, { className: classes$r.header, children: columnDef.header }))] }) })), (_a = column.columns) === null || _a === void 0 ? void 0 : _a.map((c, i) => (jsxRuntime.jsx(MTT_ShowHideColumnsMenuItems, { allColumns: allColumns, column: c, hoveredColumn: hoveredColumn, setHoveredColumn: setHoveredColumn, table: table }, `${i}-${c.id}`)))] }));
};
...
const MTT_TableFooterRow = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.TableTr, Object.assign({ className: clsx(classes$p.root, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$p["layout-mode-grid"]) }, tableRowProps, { children: [virtualPaddingLeft ? (jsxRuntime.jsx(core.Box, { component: "th", display: "flex", w: virtualPaddingLeft })) : null, (virtualColumns !== null && virtualColumns !== void 0 ? virtualColumns : footerGroup.headers).map((footerOrVirtualFooter, renderedColumnIndex) => {
                ...
                return (jsxRuntime.jsx(MTT_TableFooterCell, { footer: footer, renderedColumnIndex: renderedColumnIndex, table: table }, footer.id));
...
const MTT_TableFooter = (_a) => {
    ...
    return (jsxRuntime.jsx(core.TableTfoot, Object.assign({}, tableFooterProps, { className: clsx(classes$q.root, tableFooterProps === null || tableFooterProps === void 0 ? void 0 : tableFooterProps.className, stickFooter && classes$q.sticky, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$q.grid), ref: (ref) => {
        ...
        }, children: getFooterGroups().map((footerGroup) => (jsxRuntime.jsx(MTT_TableFooterRow, { columnVirtualizer: columnVirtualizer, footerGroup: footerGroup, table: table }, footerGroup.id))) })));
};
...
const MTT_FilterFns = Object.assign(Object.assign({}, reactTable.filterFns), { between,
    betweenInclusive,
    contains,
    empty,
    endsWith,
...
const MTT_FilterRangeFields = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.Box, Object.assign({}, rest, { className: clsx("mtt-filter-range-fields", classes$i.root, rest.className), children: [jsxRuntime.jsx(MTT_FilterTextInput, { header: header, rangeFilterIndex: 0, table: table }), jsxRuntime.jsx(MTT_FilterTextInput, { header: header, rangeFilterIndex: 1, table: table })] })));
};
...
const MTT_FilterRangeSlider = (_a) => {
    ...
    return (jsxRuntime.jsx(core.RangeSlider, Object.assign({ className: clsx("mtt-filter-range-slider", classes$g.root), max: max, min: min, onChange: (values) => {
...
const MTT_TableHeadCellFilterContainer = (_a) => {
    ...
    return (jsxRuntime.jsx(core.Collapse, { expanded: showColumnFilters || columnFilterDisplayMode === "popover", children: jsxRuntime.jsxs(core.Flex, Object.assign({ direction: "column" }, rest, { children: [jsxRuntime.jsxs(core.Flex, { align: "flex-end", children: [columnDef.filterVariant === "checkbox" ? (jsxRuntime.jsx(MTT_FilterCheckbox, { column: column, table: table })) : columnDef.filterVariant === "range-slider" ? (jsxRuntime.jsx(MTT_FilterRangeSlider, { header: header, table: table })) : ["date-range", "range"].includes((_c = columnDef.filterVariant) !== null && _c !== void 0 ? _c : "") ||
                            ["between", "betweenInclusive", "inNumberRange"].includes(columnDef._filterFn) ? (jsxRuntime.jsx(MTT_FilterRangeFields, { header: header, table: table })) : (jsxRuntime.jsx(MTT_FilterTextInput, { header: header, table: table })), showChangeModeButton && (jsxRuntime.jsxs(core.Menu, { withinPortal: columnFilterDisplayMode !== "popover", children: [jsxRuntime.jsx(core.Tooltip, { label: localization.changeFilterMode, position: "bottom-start", withinPortal: true, children: jsxRuntime.jsx(core.Menu.Target, { children: jsxRuntime.jsx(core.ActionIcon, { "aria-label": localization.changeFilterMode, color: "gray", size: "md", variant: "subtle", children: jsxRuntime.jsx(IconFilterCog, {}) }) }) }), jsxRuntime.jsx(MTT_FilterOptionMenu, { header: header, onSelect: () => setTimeout(() => { var _a; return (_a = filterInputRefs.current[`${column.id}-0`]) === null || _a === void 0 ? void 0 : _a.focus(); }, 100), table: table })] }))] }), showChangeModeButton ? (jsxRuntime.jsx(core.Text, { c: "dimmed", className: classes$k["filter-mode-label"], component: "label", children: localization.filterMode.replace("{filterType}", localizedFilterOption(localization, currentFilterOption)) })) : null] })) }));
};
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsxs(core.Popover, { keepMounted: columnDef.filterVariant === "range-slider", onChange: setPopoverOpened, onClose: () => setPopoverOpened(false), opened: popoverOpened, position: "top", shadow: "xl", width: 360, withinPortal: true, children: [jsxRuntime.jsx(core.Transition, { mounted: columnFilterDisplayMode === "popover" ||
                        ...
                        (isRangeFilter &&
                            (!!((_c = column.getFilterValue()) === null || _c === void 0 ? void 0 : _c[0]) ||
                                ...
                                } }, rest, { children: jsxRuntime.jsx(IconFilter, { size: "100%" }) })) }) })) }), columnFilterDisplayMode === "popover" && (jsxRuntime.jsx(core.Popover.Dropdown, { onClick: (event) => event.stopPropagation(), onKeyDown: (event) => event.key === "Enter" && setPopoverOpened(false), onMouseDown: (event) => event.stopPropagation(), children: jsxRuntime.jsx(MTT_TableHeadCellFilterContainer, { header: header, table: table }) }))] }) }));
};
...
const MTT_TableHeadCellSortLabel = (_a) => {
    ...
    const SortActionButton = (jsxRuntime.jsx(core.ActionIcon, Object.assign({ "aria-label": sortTooltip }, dataVariable("sorted", sorted), rest, { className: clsx("mtt-table-head-sort-button", classes$c["sort-icon"], rest.className), children: sorted === "desc" ? (jsxRuntime.jsx(IconSortDescending, { size: "100%" })) : sorted === "asc" ? (jsxRuntime.jsx(IconSortAscending, { size: "100%" })) : (jsxRuntime.jsx(IconArrowsSort, { size: "100%" })) })));
...
const MTT_TableHeadCell = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.TableTh, Object.assign({ colSpan: header.colSpan, "data-column-pinned": isColumnPinned || undefined, "data-dragging-column": isDraggingColumn || undefined, "data-first-right-pinned": (isColumnPinned === "right" &&
            ...
            if (node) {
                ...
                ? null
                : ((_f = tableCellProps.children) !== null && _f !== void 0 ? _f : (jsxRuntime.jsxs(core.Flex, { className: clsx("mtt-table-head-cell-content", classes$l.content, (columnDefType === "group" ||
                        ...
                        classes$l["content-center"], (tableCellProps === null || tableCellProps === void 0 ? void 0 : tableCellProps.align) === "right" && classes$l["content-right"], column.getCanResize() && classes$l["content-spaced"]), children: [jsxRuntime.jsxs(core.Flex, { __vars: {
                                ...
                                : (tableCellProps === null || tableCellProps === void 0 ? void 0 : tableCellProps.align) === "center" &&
                                    classes$l["labels-center"], columnDefType === "data" && classes$l["labels-data"]), onClick: column.getToggleSortingHandler(), children: [jsxRuntime.jsx(core.Flex, { className: clsx("mtt-table-head-cell-content-wrapper", classes$l["content-wrapper"], columnDefType === "data" &&
                                    ...
                                    (column.getIsFiltered() || showColumnButtons) && (jsxRuntime.jsx(MTT_TableHeadCellFilterLabel, { header: header, table: table })), column.getCanSort() &&
                                    (column.getIsSorted() || showColumnButtons) && (jsxRuntime.jsx(MTT_TableHeadCellSortLabel, { header: header, table: table }))] }), columnDefType !== "group" && (jsxRuntime.jsxs(core.Flex, { className: clsx("mtt-table-head-cell-content-actions", classes$l["content-actions"]), children: [showDragHandle && (jsxRuntime.jsx(MTT_TableHeadCellGrabHandle, { column: column, table: table, tableHeadCellRef: {
                                        current: tableHeadCellRefs.current[column.id],
                                    } })), columnActionsEnabled && showColumnButtons && (jsxRuntime.jsx(MTT_ColumnActionMenu, { header: header, onChange: setIsOpenedColumnActions, opened: isOpenedColumnActions, table: table }))] })), column.getCanResize() && (jsxRuntime.jsx(MTT_TableHeadCellResizeHandle, { header: header, table: table }))] }))), columnFilterDisplayMode === "subheader" && column.getCanFilter() && (jsxRuntime.jsx(MTT_TableHeadCellFilterContainer, { header: header, table: table }))] })));
};
...
const MTT_TableHeadRow = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.TableTr, Object.assign({}, tableRowProps, { className: clsx(classes$m.root, (enableStickyHeader || isFullScreen) && classes$m.sticky, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$m["layout-mode-grid"], tableRowProps === null || tableRowProps === void 0 ? void 0 : tableRowProps.className), children: [virtualPaddingLeft ? (jsxRuntime.jsx(core.Box, { component: "th", display: "flex", w: virtualPaddingLeft })) : null, (virtualColumns !== null && virtualColumns !== void 0 ? virtualColumns : headerGroup.headers).map((headerOrVirtualHeader, renderedHeaderIndex) => {
                ...
                return (jsxRuntime.jsx(MTT_TableHeadCell, { columnVirtualizer: columnVirtualizer, header: header, renderedHeaderIndex: renderedHeaderIndex, table: table }, header.id));
            }), virtualPaddingRight ? (jsxRuntime.jsx(core.Box, { component: "th", display: "flex", w: virtualPaddingRight })) : null] })));
};
...
const MTT_ToolbarAlertBanner = (_a) => {
    ...
    const selectedAlert = selectedRowCount ? (jsxRuntime.jsxs(core.Flex, { align: "center", gap: "sm", children: [(_c = (_b = localization.selectedCountOfRowCountRowsSelected) === null || _b === void 0 ? void 0 : _b.replace("{selectedCount}", selectedRowCount.toString())) === null || _c === void 0 ? void 0 : _c.replace("{rowCount}", totalRowCount.toString()), jsxRuntime.jsx(core.Button, { onClick: (event) => getMTT_SelectAllHandler({ table })(event, false, true), size: "compact-xs", variant: "subtle", children: localization.clearSelection })] })) : null;
    ...
    return (jsxRuntime.jsx(core.Collapse, { expanded: showAlertBanner || !!selectedAlert || !!groupedAlert, transitionDuration: stackAlertBanner ? 200 : 0, children: jsxRuntime.jsx(core.Alert, Object.assign({ color: "blue", icon: false }, alertProps, { className: clsx(classes$a.alert, stackAlertBanner &&
                ...
                table,
                    ...
                    classes$a["head-overlay"], density), children: [enableRowSelection &&
                        enableSelectAll &&
                        positionToolbarAlertBanner === "head-overlay" && (jsxRuntime.jsx(MTT_SelectCheckbox, { table: table })), jsxRuntime.jsxs(core.Stack, { children: [alertProps === null || alertProps === void 0 ? void 0 : alertProps.children, selectedAlert, groupedAlert] })] })) })) }));
};
...
const MTT_TableHead = (_a) => {
    ...
    return (jsxRuntime.jsx(core.TableThead, Object.assign({}, tableHeadProps, { className: clsx(classes$n.root, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid"))
            ...
            (showAlertBanner || getSelectedRowModel().rows.length > 0) ? (jsxRuntime.jsx(core.TableTr, { className: clsx(classes$n["banner-tr"], (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$n.grid), children: jsxRuntime.jsx(core.TableTh, { className: clsx(classes$n["banner-th"], (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$n.grid), colSpan: table.getVisibleLeafColumns().length, children: jsxRuntime.jsx(MTT_ToolbarAlertBanner, { table: table }) }) })) : (getHeaderGroups().map((headerGroup) => (jsxRuntime.jsx(MTT_TableHeadRow, { columnVirtualizer: columnVirtualizer, headerGroup: headerGroup, table: table }, headerGroup.id)))) })));
};
...
const createRow = (table, originalRow, rowIndex = -1, depth = 0, subRows, parentId) => reactTable.createRow(table, "mtt-row-create", originalRow !== null && originalRow !== void 0 ? originalRow : Object.assign({}, ...getAllLeafColumnDefs(table.options.columns).map((col) => ({
    [getColumnId(col)]: "",
}))), rowIndex, depth, subRows, parentId);

const getMTT_RowActionsColumnDef = (tableOptions) => {
    return Object.assign({ Cell: ({ cell, row, table }) => (jsxRuntime.jsx(MTT_ToggleRowActionMenuButton, { cell: cell, row: row, table: table })) }, defaultDisplayColumnProps({
        header: "actions",
        id: "mtt-row-actions",
        size: 70,
        tableOptions,
...
const getMTT_RowDragColumnDef = (tableOptions) => {
    return Object.assign({ Cell: ({ row, rowRef, table }) => (jsxRuntime.jsx(MTT_TableBodyRowGrabHandle, { row: row, rowRef: rowRef, table: table })), grow: false }, defaultDisplayColumnProps({
        header: "move",
        id: "mtt-row-drag",
        size: 60,
        tableOptions,
...
const getMTT_RowExpandColumnDef = (tableOptions) => {
    ...
    return Object.assign({ Cell: ({ cell, column, row, table }) => {
            ...
            if (tableOptions.groupedColumnMode === "remove" && row.groupingColumnId) {
                return (jsxRuntime.jsxs(core.Flex, { align: "center", gap: "0.25rem", children: [jsxRuntime.jsx(MTT_ExpandButton, Object.assign({}, expandButtonProps)), jsxRuntime.jsx(core.Tooltip, { label: table.getColumn(row.groupingColumnId).columnDef.header, openDelay: 1000, position: "right", children: jsxRuntime.jsx("span", { children: row.groupingValue }) }), !!subRowsLength && jsxRuntime.jsxs("span", { children: ["(", subRowsLength, ")"] })] }));
            }
            else {
                return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(MTT_ExpandButton, Object.assign({}, expandButtonProps)), (_c = (_b = column.columnDef).GroupedCell) === null || _c === void 0 ? void 0 : _c.call(_b, { cell, column, row, table })] }));
            }
        }, Header: enableExpandAll
            ? ({ table }) => {
                var _a;
                return (jsxRuntime.jsxs(core.Flex, { align: "center", children: [jsxRuntime.jsx(MTT_ExpandAllButton, { table: table }), groupedColumnMode === "remove" &&
...
const getMTT_RowPinningColumnDef = (tableOptions) => {
    return Object.assign({ Cell: ({ row, table }) => (jsxRuntime.jsx(MTT_TableBodyRowPinButton, { row: row, table: table })), grow: false }, defaultDisplayColumnProps({
        header: "pin",
        id: "mtt-row-pin",
        size: 60,
        tableOptions,
...
const getMTT_RowSelectColumnDef = (tableOptions) => {
    ...
    return Object.assign({ Cell: ({ renderedRowIndex, row, table }) => (jsxRuntime.jsx(MTT_SelectCheckbox, { renderedRowIndex: renderedRowIndex, row: row, table: table })), grow: false, Header: enableSelectAll && enableMultiRowSelection
            ? ({ table }) => jsxRuntime.jsx(MTT_SelectCheckbox, { table: table })
...
const MTT_AggregationFns = Object.assign({}, reactTable.aggregationFns);
...
const useMTT_TableOptions = (_a) => {
    ...
    const direction = core.useDirection();
    icons = react.useMemo(() => (Object.assign(Object.assign({}, MTT_Default_Icons), icons)), [icons]);
    localization = react.useMemo(() => (Object.assign(Object.assign({}, MTT_Localization_EN), localization)), [localization]);
    aggregationFns = react.useMemo(() => (Object.assign(Object.assign({}, MTT_AggregationFns), aggregationFns)), []);
    filterFns = react.useMemo(() => (Object.assign(Object.assign({}, MTT_FilterFns), filterFns)), []);
    sortingFns = react.useMemo(() => (Object.assign(Object.assign({}, MTT_SortingFns), sortingFns)), []);
    defaultColumn = react.useMemo(() => (Object.assign(Object.assign({}, MTT_DefaultColumn), defaultColumn)), [defaultColumn]);
    defaultDisplayColumn = react.useMemo(() => (Object.assign(Object.assign({}, MTT_DefaultDisplayColumn), defaultDisplayColumn)), [defaultDisplayColumn]);
...
const MTT_Table = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.Table, Object.assign({ className: clsx("mtt-table", classes$6.root, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith("grid")) && classes$6["root-grid"], tableProps.className) }, tableProps, { __vars: Object.assign(Object.assign(Object.assign({}, columnSizeVars), { "--mtt-striped-row-background-color": stripedColor, "--mtt-striped-row-hover-background-color": stripedColor
                ...
                : undefined }), tableProps.__vars), children: [enableTableHead && jsxRuntime.jsx(MTT_TableHead, Object.assign({}, commonTableGroupProps)), memoMode === "table-body" || columnSizingInfo.isResizingColumn ? (jsxRuntime.jsx(Memo_MTT_TableBody, Object.assign({}, commonTableGroupProps, { tableProps: tableProps }))) : (jsxRuntime.jsx(MTT_TableBody, Object.assign({}, commonTableGroupProps, { tableProps: tableProps }))), enableTableFooter && jsxRuntime.jsx(MTT_TableFooter, Object.assign({}, commonTableGroupProps))] })));
};
...
const MTT_TableContainer = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.Box, Object.assign({}, tableContainerProps, { __vars: Object.assign({ "--mtt-top-toolbar-height": `${totalToolbarHeight}` }, tableContainerProps === null || tableContainerProps === void 0 ? void 0 : tableContainerProps.__vars), className: clsx("mtt-table-container", classes$7.root, enableStickyHeader && classes$7["root-sticky"], isFullScreen && classes$7["root-fullscreen"], tableContainerProps === null || tableContainerProps === void 0 ? void 0 : tableContainerProps.className), ref: (node) => {
        ...
        }, children: [jsxRuntime.jsx(core.LoadingOverlay, Object.assign({ visible: isLoading || showLoadingOverlay, zIndex: 2 }, loadingOverlayProps)), jsxRuntime.jsx(MTT_Table, { table: table }), (createModalOpen || editModalOpen) && (jsxRuntime.jsx(MTT_EditRowModal, { open: true, table: table }))] })));
};
...
const MTT_ToolbarDropZone = (_a) => {
    ...
    return (jsxRuntime.jsx(core.Transition, { mounted: showToolbarDropZone, transition: "fade", children: () => {
            var _a, _b;
            return (jsxRuntime.jsx(core.Flex, Object.assign({ className: clsx("mtt-toolbar-dropzone", classes$2.root, (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === "drop-zone" && classes$2.hovered), onDragEnter: handleDragEnter }, rest, { children: jsxRuntime.jsx(core.Text, { children: localization.dropToGroupBy.replace("{column}", (_b = (_a = draggingColumn === null || draggingColumn === void 0 ? void 0 : draggingColumn.columnDef) === null || _a === void 0 ? void 0 : _a.header) !== null && _b !== void 0 ? _b : "") }) })));
        } }));
};
...
const MTT_BottomToolbar = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.Box, Object.assign({}, toolbarProps, { className: clsx("mtt-bottom-toolbar", classes$5.root, commonClasses["common-toolbar-styles"], isFullScreen && classes$5["root-fullscreen"], toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.className), ref: (node) => {
            if (node) {
                bottomToolbarRef.current = node;
                assignRef(toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.ref, node);
            }
        }, children: [jsxRuntime.jsx(MTT_ProgressBar, { isTopToolbar: false, table: table }), positionToolbarAlertBanner === "bottom" && (jsxRuntime.jsx(MTT_ToolbarAlertBanner, { stackAlertBanner: stackAlertBanner, table: table })), ["both", "bottom"].includes(positionToolbarDropZone !== null && positionToolbarDropZone !== void 0 ? positionToolbarDropZone : "") && (jsxRuntime.jsx(MTT_ToolbarDropZone, { table: table })), jsxRuntime.jsxs(core.Box, { className: classes$5["custom-toolbar-container"], children: [renderBottomToolbarCustomActions ? (renderBottomToolbarCustomActions({ table })) : (jsxRuntime.jsx("span", {})), jsxRuntime.jsx(core.Box, { className: clsx(classes$5["paginator-container"], stackAlertBanner && classes$5["paginator-container-alert-banner"]), children: enablePagination &&
                            ["both", "bottom"].includes(positionPagination !== null && positionPagination !== void 0 ? positionPagination : "") && (jsxRuntime.jsx(MTT_TablePagination, { position: "bottom", table: table })) })] })] })));
};
...
const MTT_ToolbarInternalButtons = (_a) => {
    ...
    return (jsxRuntime.jsx(core.Flex, Object.assign({}, rest, { className: clsx("mtt-toolbar-internal-buttons", classes.root, rest === null || rest === void 0 ? void 0 : rest.className), children: (_b = renderToolbarInternalActions === null || renderToolbarInternalActions === void 0 ? void 0 : renderToolbarInternalActions({ table })) !== null && _b !== void 0 ? _b : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [enableFilters &&
                    enableGlobalFilter &&
                    !(initialState === null || initialState === void 0 ? void 0 : initialState.showGlobalFilter) && (jsxRuntime.jsx(MTT_ToggleGlobalFilterButton, { table: table })), enableFilters &&
                    enableColumnFilters &&
                    columnFilterDisplayMode !== "popover" && (jsxRuntime.jsx(MTT_ToggleFiltersButton, { table: table })), (enableHiding || enableColumnOrdering || enableColumnPinning) && (jsxRuntime.jsx(MTT_ShowHideColumnsButton, { table: table })), enableDensityToggle && (jsxRuntime.jsx(MTT_ToggleDensePaddingButton, { table: table })), enableFullScreenToggle && (jsxRuntime.jsx(MTT_ToggleFullScreenButton, { table: table }))] })) })));
};
...
const MTT_TopToolbar = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.Box, Object.assign({}, toolbarProps, { className: clsx(commonClasses["common-toolbar-styles"], classes$1["root"], isFullScreen && classes$1["root-fullscreen"], toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.className), ref: (node) => {
        ...
        }, children: [positionToolbarAlertBanner === "top" && (jsxRuntime.jsx(MTT_ToolbarAlertBanner, { stackAlertBanner: stackAlertBanner, table: table })), ["both", "top"].includes(positionToolbarDropZone !== null && positionToolbarDropZone !== void 0 ? positionToolbarDropZone : "") && (jsxRuntime.jsx(MTT_ToolbarDropZone, { table: table })), jsxRuntime.jsxs(core.Flex, { className: clsx(classes$1["actions-container"], stackAlertBanner && classes$1["actions-container-stack-alert"]), children: [enableGlobalFilter && positionGlobalFilter === "left" && (jsxRuntime.jsx(MTT_GlobalFilterTextInput, Object.assign({}, globalFilterProps))), (_b = renderTopToolbarCustomActions === null || renderTopToolbarCustomActions === void 0 ? void 0 : renderTopToolbarCustomActions({ table })) !== null && _b !== void 0 ? _b : jsxRuntime.jsx("span", {}), enableToolbarInternalActions ? (jsxRuntime.jsxs(core.Flex, { justify: "end", wrap: "wrap-reverse", children: [enableGlobalFilter && positionGlobalFilter === "right" && (jsxRuntime.jsx(MTT_GlobalFilterTextInput, Object.assign({}, globalFilterProps))), jsxRuntime.jsx(MTT_ToolbarInternalButtons, { table: table })] })) : (enableGlobalFilter &&
                        positionGlobalFilter === "right" && (jsxRuntime.jsx(MTT_GlobalFilterTextInput, Object.assign({}, globalFilterProps))))] }), enablePagination &&
                ["both", "top"].includes(positionPagination !== null && positionPagination !== void 0 ? positionPagination : "") && (jsxRuntime.jsx(core.Flex, { justify: "end", children: jsxRuntime.jsx(MTT_TablePagination, { position: "top", table: table }) })), jsxRuntime.jsx(MTT_ProgressBar, { isTopToolbar: true, table: table })] })));
};
...
const MTT_TablePaper = (_a) => {
    ...
    return (jsxRuntime.jsxs(core.Paper, Object.assign({ shadow: "xs", withBorder: true }, tablePaperProps, { className: clsx("mtt-table-paper", classes$8.root, isFullScreen && "mtt-table-paper-fullscreen", tablePaperProps === null || tablePaperProps === void 0 ? void 0 : tablePaperProps.className), ref: (ref) => {
        ...
        style: (theme) => (Object.assign(Object.assign({ zIndex: isFullScreen ? 200 : undefined }, parseFromValuesOrFunc(tablePaperProps === null || tablePaperProps === void 0 ? void 0 : tablePaperProps.style, theme)), (isFullScreen
            ...
            : null))), children: [enableTopToolbar &&
                ((_b = parseFromValuesOrFunc(renderTopToolbar, { table })) !== null && _b !== void 0 ? _b : (jsxRuntime.jsx(MTT_TopToolbar, { table: table }))), jsxRuntime.jsx(MTT_TableContainer, { table: table }), enableBottomToolbar &&
                ((_c = parseFromValuesOrFunc(renderBottomToolbar, { table })) !== null && _c !== void 0 ? _c : (jsxRuntime.jsx(MTT_BottomToolbar, { table: table })))] })));
};
...
const MantineTanstackTable = (props) => {
    ...
    return jsxRuntime.jsx(MTT_TablePaper, { table: table });
};

exports.MTT_AggregationFns = MTT_AggregationFns;
exports.MTT_BottomToolbar = MTT_BottomToolbar;
exports.MTT_ColumnActionMenu = MTT_ColumnActionMenu;
exports.MTT_ColumnPinningButtons = MTT_ColumnPinningButtons;
exports.MTT_CopyButton = MTT_CopyButton;
exports.MTT_DefaultColumn = MTT_DefaultColumn;
exports.MTT_DefaultDisplayColumn = MTT_DefaultDisplayColumn;
exports.MTT_EditActionButtons = MTT_EditActionButtons;
exports.MTT_EditCellTextInput = MTT_EditCellTextInput;
exports.MTT_EditRowModal = MTT_EditRowModal;
exports.MTT_ExpandAllButton = MTT_ExpandAllButton;
exports.MTT_ExpandButton = MTT_ExpandButton;
exports.MTT_FilterCheckbox = MTT_FilterCheckbox;
exports.MTT_FilterFns = MTT_FilterFns;
exports.MTT_FilterOptionMenu = MTT_FilterOptionMenu;
exports.MTT_FilterRangeFields = MTT_FilterRangeFields;
exports.MTT_FilterRangeSlider = MTT_FilterRangeSlider;
exports.MTT_FilterTextInput = MTT_FilterTextInput;
exports.MTT_GlobalFilterTextInput = MTT_GlobalFilterTextInput;
exports.MTT_GrabHandleButton = MTT_GrabHandleButton;
exports.MTT_ProgressBar = MTT_ProgressBar;
exports.MTT_RowActionMenu = MTT_RowActionMenu;
exports.MTT_RowPinButton = MTT_RowPinButton;
exports.MTT_SelectCheckbox = MTT_SelectCheckbox;
exports.MTT_ShowHideColumnsButton = MTT_ShowHideColumnsButton;
exports.MTT_ShowHideColumnsMenu = MTT_ShowHideColumnsMenu;
exports.MTT_ShowHideColumnsMenuItems = MTT_ShowHideColumnsMenuItems;
exports.MTT_SortingFns = MTT_SortingFns;
exports.MTT_Table = MTT_Table;
exports.MTT_TableBody = MTT_TableBody;
exports.MTT_TableBodyCell = MTT_TableBodyCell;
exports.MTT_TableBodyCellValue = MTT_TableBodyCellValue;
exports.MTT_TableBodyEmptyRow = MTT_TableBodyEmptyRow;
exports.MTT_TableBodyRow = MTT_TableBodyRow;
exports.MTT_TableBodyRowGrabHandle = MTT_TableBodyRowGrabHandle;
exports.MTT_TableBodyRowPinButton = MTT_TableBodyRowPinButton;
exports.MTT_TableContainer = MTT_TableContainer;
exports.MTT_TableDetailPanel = MTT_TableDetailPanel;
exports.MTT_TableFooter = MTT_TableFooter;
exports.MTT_TableFooterCell = MTT_TableFooterCell;
exports.MTT_TableFooterRow = MTT_TableFooterRow;
exports.MTT_TableHead = MTT_TableHead;
exports.MTT_TableHeadCell = MTT_TableHeadCell;
exports.MTT_TableHeadCellFilterContainer = MTT_TableHeadCellFilterContainer;
exports.MTT_TableHeadCellFilterLabel = MTT_TableHeadCellFilterLabel;
exports.MTT_TableHeadCellGrabHandle = MTT_TableHeadCellGrabHandle;
exports.MTT_TableHeadCellResizeHandle = MTT_TableHeadCellResizeHandle;
exports.MTT_TableHeadCellSortLabel = MTT_TableHeadCellSortLabel;
exports.MTT_TableHeadRow = MTT_TableHeadRow;
exports.MTT_TablePagination = MTT_TablePagination;
exports.MTT_TablePaper = MTT_TablePaper;
exports.MTT_ToggleDensePaddingButton = MTT_ToggleDensePaddingButton;
exports.MTT_ToggleFiltersButton = MTT_ToggleFiltersButton;
exports.MTT_ToggleFullScreenButton = MTT_ToggleFullScreenButton;
exports.MTT_ToggleGlobalFilterButton = MTT_ToggleGlobalFilterButton;
exports.MTT_ToggleRowActionMenuButton = MTT_ToggleRowActionMenuButton;
exports.MTT_ToolbarAlertBanner = MTT_ToolbarAlertBanner;
exports.MTT_ToolbarDropZone = MTT_ToolbarDropZone;
exports.MTT_ToolbarInternalButtons = MTT_ToolbarInternalButtons;
exports.MTT_TopToolbar = MTT_TopToolbar;
exports.MantineTanstackTable = MantineTanstackTable;
exports.Memo_MTT_TableBody = Memo_MTT_TableBody;
exports.Memo_MTT_TableBodyCell = Memo_MTT_TableBodyCell;
exports.Memo_MTT_TableBodyRow = Memo_MTT_TableBodyRow;
exports.assignRef = assignRef;
exports.createMTTColumnHelper = createMTTColumnHelper;
...
exports.getMTT_RowSelectionHandler = getMTT_RowSelectionHandler;
exports.getMTT_Rows = getMTT_Rows;
exports.getMTT_SelectAllHandler = getMTT_SelectAllHandler;
...
exports.mttFilterOptions = mttFilterOptions;
...
exports.useMTT_ColumnVirtualizer = useMTT_ColumnVirtualizer;
exports.useMTT_Effects = useMTT_Effects;
exports.useMTT_RowVirtualizer = useMTT_RowVirtualizer;
exports.useMTT_Rows = useMTT_Rows;
exports.useMTT_TableInstance = useMTT_TableInstance;
exports.useMTT_TableOptions = useMTT_TableOptions;
exports.useMantineTanstackTable = useMantineTanstackTable;
